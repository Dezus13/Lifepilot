...
В текущем учебном MVP пользователь вставляет текст письма, документа или ситуации вручную. Данные текущего кейса хранятся в браузере. Backend, auth, database, файловая загрузка и распознавание документов не входят в первую версию. Полный список ограничений хранится в `docs/plans/mvp-scope.md`.
